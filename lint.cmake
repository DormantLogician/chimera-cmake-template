...
execute_process(COMMAND ${CMAKE_COMMAND} --preset ${RELEASE_PRESET} WORKING_DIRECTORY target OUTPUT_QUIET COMMAND_ERROR_IS_FATAL ANY)

message(STATUS "Build and test with release configuration...")
execute_process(COMMAND ${CMAKE_COMMAND} --build --preset ${RELEASE_PRESET} WORKING_DIRECTORY target  COMMAND_ERROR_IS_FATAL ANY)
execute_process(COMMAND ${CTEST_EXE} --preset ${RELEASE_PRESET} WORKING_DIRECTORY target COMMAND_ERROR_IS_FATAL ANY)

message(STATUS "Configure CMake project...")
execute_process(COMMAND ${CMAKE_COMMAND} --preset ${TEST_PRESET} WORKING_DIRECTORY target OUTPUT_QUIET COMMAND_ERROR_IS_FATAL ANY)

message(STATUS "Build and test with sanitizers...")
execute_process(COMMAND ${CMAKE_COMMAND} --build --preset ${TEST_PRESET} WORKING_DIRECTORY target COMMAND_ERROR_IS_FATAL ANY)
execute_process(COMMAND ${CTEST_EXE} --preset ${TEST_PRESET} WORKING_DIRECTORY target COMMAND_ERROR_IS_FATAL ANY)
