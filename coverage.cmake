...
execute_process(COMMAND ${CMAKE_COMMAND} --preset ${COVERAGE_PRESET} WORKING_DIRECTORY target OUTPUT_QUIET COMMAND_ERROR_IS_FATAL ANY)

message(STATUS "Build and test with code coverage...")
execute_process(COMMAND ${CMAKE_COMMAND} --build --preset ${COVERAGE_PRESET} WORKING_DIRECTORY target COMMAND_ERROR_IS_FATAL ANY)
execute_process(COMMAND ${CTEST_EXE} --preset ${COVERAGE_PRESET} WORKING_DIRECTORY target COMMAND_ERROR_IS_FATAL ANY)
